...
router.delete(
  ...
  tutorialCenterController.deleteCenter,
);
router.get(
  "/students",
  cacheMiddleware(120),
...
router.get(
  ...
  tutorialCenterController.getStudentProfile,
);
router.get(
  "/students/:studentId/test-history",
  tutorialCenterController.getStudentTestHistory,
);
router.get(
  "/students/:studentId/analytics",
  tutorialCenterController.getStudentDetailedAnalytics,
);
router.get(
  "/students/:studentId/progress",
  tutorialCenterController.getStudentProgress,
);
router.post(
  "/students/:studentId/report",
  tutorialCenterController.generateStudentReport,
);
router.get(
  "/students/:studentId/notes",
  tutorialCenterController.getStudentNotes,
);
router.post(
  "/students/:studentId/notes",
  tutorialCenterController.addStudentNote,
);
router.get(
  "/students/alerts/all",
  cacheMiddleware(120),
...
router.get(
  "/analytics/:centerId",
  tutorialCenterController.getStudentAnalytics,
);
router.get(
  "/advanced-analytics",
  cacheMiddleware(60),
  tutorialCenterController.getAdvancedAnalytics,
); // Cache 1min
...
router.post(
  "/tc-questions",
  checkCenterSuspension,
  checkLimit("questions"),
  writeLimiter,
  questionValidation,
  tutorialCenterController.createQuestion,
);
router.get(
  "/tc-questions",
  paginationValidation,
...
router.put(
  ...
  uuidValidation("id"),
  questionValidation,
  tutorialCenterController.updateQuestion,
);
router.delete(
  "/tc-questions/:id",
  checkCenterSuspension,
  writeLimiter,
  uuidValidation("id"),
  tutorialCenterController.deleteQuestion,
);
router.post(
  "/tc-questions/generate-ai",
  checkCenterSuspension,
  checkLimit("questions", (req) => req.body.questions?.length || 10),
  writeLimiter,
  tutorialCenterController.generateQuestionsAI,
);
router.post(
  "/tc-questions/generate-ai-stream",
  checkCenterSuspension,
  checkLimit("questions", (req) => req.body.count || 10),
  writeLimiter,
  tutorialCenterController.generateQuestionsAIStream,
);
router.post(
  "/tc-questions/parse-bulk",
  checkCenterSuspension,
  writeLimiter,
  tutorialCenterController.parseBulkQuestions,
);
router.post(
  "/tc-questions/save-bulk",
  checkCenterSuspension,
  checkLimit("questions", (req) => req.body.questions?.length || 0),
  writeLimiter,
  tutorialCenterController.saveBulkQuestions,
);
...
router.post(
  ...
  writeLimiter,
  questionSetValidation,
  tutorialCenterController.createQuestionSet,
);
router.get(
  "/tc-question-sets",
  paginationValidation,
...
router.get(
  "/tc-question-sets/:id",
  uuidValidation("id"),
  tutorialCenterController.getQuestionSet,
);
router.put(
  "/tc-question-sets/:id",
  checkCenterSuspension,
  ...
  uuidValidation("id"),
  questionSetValidation,
  tutorialCenterController.updateQuestionSet,
);
router.put(
  "/tc-question-sets/:id/toggle-answers",
  checkCenterSuspension,
  writeLimiter,
  uuidValidation("id"),
  tutorialCenterController.toggleAnswers,
);
router.delete(
  "/tc-question-sets/:id",
  checkCenterSuspension,
  writeLimiter,
  uuidValidation("id"),
  tutorialCenterController.deleteQuestionSet,
);

// Question set questions management (block if suspended)
router.post(
  "/tc-question-sets/:id/questions",
  checkCenterSuspension,
  writeLimiter,
  uuidValidation("id"),
  tutorialCenterController.addQuestionsToTest,
);
router.delete(
  "/tc-question-sets/:testId/questions/:questionId",
  checkCenterSuspension,
  writeLimiter,
  tutorialCenterController.removeQuestionFromTest,
);
router.get(
  "/tc-question-sets/:id/questions",
  uuidValidation("id"),
  cacheMiddleware(600, true),
  tutorialCenterController.getTestQuestions,
); // Shared cache 10min - questions don't change often
...
router.get(
  "/tests/:testId/check-access",
  tutorialCenterController.checkTestAccess,
);
