          ...
          <WalletProvider>
            <div className="App">
              ...
              <Routes>
                ...
                {/* JAMB Services */}
                <Route
                  path="/dashboard/buy-olevel-upload"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <OLevelUploadExisting />
                      </EducationalSidebar>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/dashboard/buy-admission-letter"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <AdmissionLetter />
                ...
                />
                <Route
                  path="/dashboard/buy-original-result"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <OriginalResult />
                ...
                />
                <Route
                  path="/dashboard/buy-pin-vending"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <PinVending />
                ...
                />
                <Route
                  path="/dashboard/reprinting-jamb-caps"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <Reprinting />
                ...
                {/* Result Checkers */}
                <Route
                  path="/dashboard/scratch-card/waec-checker"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <WaecResultChecker />
                ...
                />
                <Route
                  path="/dashboard/scratch-card/neco-checker"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <NecoResultChecker />
                ...
                />
                <Route
                  path="/dashboard/scratch-card/nbais-checker"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <NbaisResultChecker />
                ...
                />
                <Route
                  path="/dashboard/scratch-card/nabteb-checker"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <NabtebResultChecker />
                ...
                />
                <Route
                  path="/dashboard/scratch-card/waec-gce"
                  element={
                    <ProtectedRoute>
                      <EducationalSidebar>
                        <WaecGceChecker />
                ...
                {/* Legacy Routes (redirected through ProtectedRoute for auth safety) */}
                <Route
                  path="/profile"
                  element={
                    <ProtectedRoute>
                ...
                />
                <Route
                  path="/tutor/questions/bulk-import"
                  element={
                    <RoleProtectedRoute allowedRoles={["tutor", "admin"]}>
                      <BulkQuestionImport />
                    </RoleProtectedRoute>
                ...
                />
                <Route
                  path="/tutor/students/:studentId/profile"
                  element={
                    <RoleProtectedRoute allowedRoles={["tutor", "admin"]}>
                      <StudentProfile />
                    </RoleProtectedRoute>
                ...
                />
                <Route
                  path="/tutor/students/alerts/all"
                  element={
                    <RoleProtectedRoute allowedRoles={["tutor", "admin"]}>
                      <StudentAlerts />
                    </RoleProtectedRoute>
                ...
                />
                <Route
                  path="/tutor/analytics/comparative"
                  element={
                    <RoleProtectedRoute allowedRoles={["tutor", "admin"]}>
                ...
                />
                <Route
                  path="/tutor/subscription/success"
                  element={
                    <RoleProtectedRoute allowedRoles={["tutor", "admin"]}>
                      <Subscription />
                    </RoleProtectedRoute>
                ...
                />
                <Route
                  path="/student/analytics/:centerId"
                  element={
                    <RoleProtectedRoute allowedRoles={["student"]}>
                      <StudentAnalytics />
                    </RoleProtectedRoute>
