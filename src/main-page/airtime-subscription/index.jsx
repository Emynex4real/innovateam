...
const AirtimeSubscription = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (network && mobileNumber && amount) {
      alert(`Airtime subscription for ${mobileNumber} on ${network} with amount ${amount} is being processed.`);
      // Add logic to process the airtime subscription
    } else {
