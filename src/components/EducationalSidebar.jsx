...
const EducationalSidebar = ({ children }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: BookOpenIcon,
      path: userRole === "student" ? "/student/dashboard" : "/tutor",
    },
    {
      id: "transactions",
      label: "Transactions",
  ...
  return (
    <div
      className={`flex min-h-screen ${isDarkMode ? "bg-gray-950 text-gray-100" : "bg-gray-50 text-gray-900"} transition-colors duration-300`}
    >
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <ChevronDownIcon
                  className={`h-4 w-4 hidden md:block transition-transform duration-200 ${showUserDropdown ? "rotate-180" : ""}`}
                />
              </button>
              ...
              <AnimatePresence>
                {showUserDropdown && (
                  ...
                  >
                    <div
                      className={`px-5 py-4 border-b ${isDarkMode ? "border-gray-800" : "border-gray-100"}`}
                    >
                    ...
                    <div className="p-2 space-y-1">
                      ...
                      {isAdmin && (
                        ...
                        >
                          <ShieldCheckIcon className="w-4 h-4 mr-3" /> Admin
                          Panel
                        </Link>
                      )}
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
            ...
            <div
              className={`relative overflow-hidden rounded-2xl p-5 shadow-lg group transition-all duration-300 hover:shadow-xl ${
                isDarkMode
            ...
            <nav className="space-y-1">
              {menuItems.map((item) => {
                    ...
                    <div key={item.id} className="space-y-1">
                      ...
                      >
                        <div className="flex items-center">
                          <item.icon
                            className={`h-5 w-5 mr-3 ${isActive ? "text-green-600 dark:text-green-400" : "text-gray-400"}`}
                          />
                          <span>{item.label}</span>
                        </div>
                        <ChevronDownIcon
                          className={`h-4 w-4 transition-transform duration-300 ${isExpanded ? "rotate-180" : ""} opacity-50`}
                        />
                      </button>
                ...
                return (
                  ...
                  >
                    <item.icon
                      className={`h-5 w-5 mr-3 ${isActive ? "text-white" : item.isAdmin ? "text-orange-500" : "text-gray-400 group-hover:text-gray-600"}`}
                    />
