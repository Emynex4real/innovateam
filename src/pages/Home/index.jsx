          ...
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center space-x-2 group">
              <div className="relative">
                <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center shadow-lg shadow-green-500/30 group-hover:shadow-green-500/50 transition-all duration-300 group-hover:scale-105">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-medium text-green-600 dark:text-green-400 tracking-wider uppercase">
                  Education
                </span>
              </div>
            </Link>
  ...
  const services = [
    {
      ...
      title: 'AI Examiner',
      description: 'Upload documents and generate practice questions with AI-powered feedback',
    ...
    },
    {
      ...
      description: 'Get personalized course recommendations based on your JAMB score and interests',
      link: '/course-advisor',
      badge: 'Popular',
    ...
    },
    {
      ...
      description: 'Access thousands of practice questions with detailed explanations',
    ...
    },
    {
      ...
      title: 'Collaboration',
      description: 'Study groups, forums, and messaging for collaborative learning',
    ...
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: 'JAMB Services',
      description: 'Complete JAMB registration, result checking, and O-level upload',
      link: '/dashboard',
      badge: 'Official',
            ...
            <div className="space-y-8">
              <div className="animate-fade-in">
                ...
                <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight tracking-tight">
                  ...
                  <span className="block bg-gradient-to-r from-green-600 via-emerald-500 to-green-500 bg-clip-text text-transparent animate-gradient">
                    Education Platform
                  </span>
                </h1>
                
                <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
                  AI-powered learning, smart course recommendations, and comprehensive JAMB services — all in one platform. Join <span className="text-primary font-semibold">2,800+ students</span> achieving academic excellence.
                </p>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From AI-powered learning to collaborative study tools — access all features in your dashboard.
            </p>
          </div>
              ...
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                <CardHeader>
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <Badge variant="secondary" className="text-xs font-bold">{service.badge}</Badge>
                  </div>
                  <CardTitle className="text-lg group-hover:text-primary transition-colors">{service.title}</CardTitle>
                  <CardDescription className="text-sm">{service.description}</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button asChild variant="ghost" className="w-full group-hover:bg-primary/10 transition-all">
