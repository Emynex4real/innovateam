...
// import TeacherCircle from "./TeacherCircle/index"; // Assuming this is the correct import path
import image from "../../../images/pexels-cottonbro-6344238.jpg";
import { Users } from 'lucide-react';
import TeacherCircle from './../TeacherCircle/index';
          ...
          {teachers.map((teacher, index) => (
            ...
            >
              ...
              {hoveredTeacher === index && (
                <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-white p-2 rounded-lg shadow-md text-center transition-opacity duration-300 opacity-0 group-hover:opacity-100">
                  <p className="text-xs font-semibold text-gray-800">{teacher.name}</p>
                </div>
              )}
            </div>
          ))}
