        ...
        <div className="flex flex-col gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2 bg-indigo-50 dark:bg-indigo-950/30 text-indigo-700 dark:text-indigo-400 px-3 sm:px-4 py-1.5 rounded-full text-sm font-bold border border-indigo-200 dark:border-indigo-900">
