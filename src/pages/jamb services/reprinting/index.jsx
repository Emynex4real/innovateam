...
import { PrinterIcon, WalletIcon, ArrowPathIcon, DocumentDuplicateIcon } from '@heroicons/react/24/outline';
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.success('Transaction successful!', {
          description: `Amount: ₦${amount.toLocaleString()}, Type: ${typeLabel}, Quantity: ${quantity}`,
          duration: 5000,
        });
        // Reset form
        setType('');
    ...
    <div className="bg-gray-50 min-h-screen py-6 font-nunito">
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">CAPS Printing</h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 bg-white p-6 rounded-xl shadow-md">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-bold text-gray-800">Printing Details</h2>
            </div>
