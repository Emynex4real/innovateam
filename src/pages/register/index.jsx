    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4 font-nunito">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8 transition-all duration-300 hover:shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              } bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 text-sm`}
          ...
          <div className="flex items-start">
            <input
              ...
              onChange={handleChange}
              className="mt-1 w-4 h-4 text-indigo-500 border-gray-300 rounded focus:ring-indigo-500 disabled:opacity-50"
              disabled={isLoading}
            />
            <label htmlFor="agreeToTerms" className="ml-2 text-sm text-gray-600">
              I agree to the{" "}
              <Link to="/terms" className="text-indigo-500 hover:text-indigo-600">
          ...
          <button
            type="submit"
            className="w-full bg-indigo-500 text-white py-3 rounded-md font-semibold hover:bg-indigo-600 transition-all duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            disabled={isLoading}
          >
            {isLoading && (
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="text-indigo-500 font-semibold hover:text-indigo-600 transition-colors duration-200">
            Sign In
          </Link>
        </p>
      </div>
