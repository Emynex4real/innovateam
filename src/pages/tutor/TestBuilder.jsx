                        ...
                        <div className="space-y-5 animate-in fade-in">
                            ...
                            <div className="space-y-3">
                                <label className="flex items-center gap-2">
                                    <input type="checkbox" checked={formData.auto_activate} onChange={(e) => setFormData({ ...formData, auto_activate: e.target.checked })} className="w-4 h-4 text-green-600" />
                                    <span className="text-sm">Auto-activate at start time</span>
                                </label>
                                <label className="flex items-center gap-2">
                                    <input type="checkbox" checked={formData.auto_deactivate} onChange={(e) => setFormData({ ...formData, auto_deactivate: e.target.checked })} className="w-4 h-4 text-green-600" />
                            ...
                            <div className={`mt-4 pt-4 border-t ${isDarkMode ? 'border-gray-800' : 'border-gray-100'}`}>
                                <label className="flex items-center gap-2 mb-4">
                                    <input type="checkbox" checked={formData.is_recurring} onChange={(e) => setFormData({ ...formData, is_recurring: e.target.checked })} className="w-4 h-4 text-green-600" />
                            ...
                            return (
                                <div key={subject} className={`border rounded-lg overflow-hidden transition-all ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3">
                                            {selectedInSubject > 0 && (
                                                <span className="text-xs font-medium text-green-500">{selectedInSubject} selected</span>
                                            )}
                                            <button
                                                type="button"
                                                        ...
                                                        {isTopicExpanded && (
                                                            <div className="grid gap-2 p-2 pl-12 bg-black/5 dark:bg-white/5">
                                                                {topicQuestions.map(q => (
                                                                    ...
                                                                    >
                                                                        <div className={`mt-0.5 w-4 h-4 rounded border flex items-center justify-center ${selectedQuestions.includes(q.id) ? 'bg-green-600 border-green-600' : 'border-gray-400'}`}>
