      ...
      <div className={`relative flex flex-col items-center p-6 rounded-2xl border transition-all duration-300 ${
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-2 text-xs font-medium bg-white dark:bg-gray-800 px-3 py-1 rounded-full border border-gray-100 dark:border-gray-700 shadow-sm">
            ...
            <span className="text-gray-500">{user.totalSessions} Quiz</span>
          </div>
        </div>
        ...
        <div className={`absolute -bottom-3 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm border-2 text-white shadow-sm ${
           rank === 1 ? 'bg-yellow-400 border-yellow-200' : 
           rank === 2 ? 'bg-gray-400 border-gray-200' : 
        ...
        <Card className="border border-gray-100 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900">
           <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50 flex justify-between items-center rounded-t-xl">
              <div className="flex items-center gap-2">
                 ...
                 <span className="font-bold text-sm text-gray-700 dark:text-gray-300">All Rankings</span>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white">10 points</p>
                    <p className="text-sm text-gray-500">For every correct answer you get.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                  <Zap className="w-5 h-5 text-yellow-500 mt-0.5" />
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white">50 points</p>
                    <p className="text-sm text-gray-500">Bonus for completing a full practice session.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                  <BookOpen className="w-5 h-5 text-blue-500 mt-0.5" />
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white">2x Multiplier</p>
                    <p className="text-sm text-gray-500">Your average score is doubled and added to your total.</p>
                  </div>
                </div>
              </div>
              ...
              <button 
                onClick={() => setShowRules(false)}
                className="w-full mt-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-xl font-bold transition-colors"
              >
                Got it!
              </button>
            </motion.div>
