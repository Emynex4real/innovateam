      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative">
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-800 tracking-tight mb-2 relative z-10">NABTEB Result Checker</h1>
            <p className="text-gray-600 text-lg relative z-10">Purchase your NABTEB scratch cards securely</p>
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div variants={cardVariants} className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 relative overflow-hidden">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">Purchase NABTEB Scratch Cards</h2>
